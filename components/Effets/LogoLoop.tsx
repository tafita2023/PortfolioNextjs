...
export interface LogoLoopProps {
  ...
  showTitleOnHover?: boolean; // Ajoutée ici
...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    fadeOutColor,
    scaleOnHover = false,
    showTitleOnHover = false, // <-- Ajoutée ici avec une valeur par défaut
    renderItem,
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const content = isNodeItem ? (
          <div className="relative group/logo">
            ...
            {/* Tooltip pour le titre au survol */}
            {showTitleOnHover && (item as any).title && (
              <div className={cx(
                'absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2',
                'px-3 py-1.5 bg-gray-900/90 backdrop-blur-sm',
                'text-white text-sm font-medium rounded-lg',
                'opacity-0 invisible group-hover/logo:opacity-100 group-hover/logo:visible',
          ...
          <div className="relative group/logo">
            ...
            {/* Tooltip pour le titre au survol */}
            {showTitleOnHover && ((item as any).title || (item as any).alt) && (
              <div className={cx(
                'absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2',
                'px-3 py-1.5 bg-gray-900/90 backdrop-blur-sm',
                'text-white text-sm font-medium rounded-lg',
      ...
      [isVertical, scaleOnHover, renderItem, showTitleOnHover]
    );
